...
public interface AAuthorityMapper {
    ...
    AAuthority selectByPrimaryKey(Integer id);
    ...
    int updateByPrimaryKey(AAuthority record);
    ...
    AAuthority selectByName(String name);
    ...
    AAuthority authentication(AAuthority record);
}